...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Administrator\\Desktop\\实验\\实验指导\\指导_lastrun.py',
...
movie_2 = visual.MovieStim3(
    win=win, name='movie_2', units='',
    noAudio = False,
    filename='petal_20220503_192300.mp4',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='游戏的规则是：\n按下黑色S大概率会跳到黑色AB，\n小概率跳到红色AB\n\n同样，\n\n按下红色S大概率会跳转到红色AB，\n小概率跳到黑色AB\n\n按空格键继续\n',
    font='Open Sans',
    pos=(-0.05, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=0.0);
...
# --- Initialize components for Routine "pro1" ---
image = visual.ImageStim(
    win=win,
    name='image', 
    image='图片1.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.3, 0.8),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
key_resp_5 = keyboard.Keyboard()

# --- Initialize components for Routine "pro2" ---
image_2 = visual.ImageStim(
    win=win,
    name='image_2', 
    image='图片2.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.3, 0.8),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
# --- Initialize components for Routine "pro3" ---
image_3 = visual.ImageStim(
    win=win,
    name='image_3', 
    image='图片4.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.3, 0.8),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
# --- Initialize components for Routine "pro4" ---
image_4 = visual.ImageStim(
    win=win,
    name='image_4', 
    image='图片3.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.3, 0.8),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
while continueRoutine and routineTimer.getTime() < 12.0:
    ...
    if movie_2.status == STARTED:
        ...
        if tThisFlipGlobal > movie_2.tStartRefresh + 12.0-frameTolerance:
...
_key_resp_3_allKeys = []
# keep track of which components have finished
ins1Components = [text_3, key_resp_3]
...
_key_resp_4_allKeys = []
# keep track of which components have finished
ins2Components = [key_resp_4, text_4]
...
_key_resp_5_allKeys = []
# keep track of which components have finished
pro1Components = [image, key_resp_5]
for thisComponent in pro1Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
thisExp.nextEntry()
# the Routine "pro1" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()

# --- Prepare to start Routine "pro2" ---
continueRoutine = True
routineForceEnded = False
# update component parameters for each repeat
key_resp_7.keys = []
...
_key_resp_7_allKeys = []
# keep track of which components have finished
pro2Components = [image_2, key_resp_7]
for thisComponent in pro2Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
thisExp.nextEntry()
# the Routine "pro2" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
_key_resp_6_allKeys = []
# keep track of which components have finished
ins3Components = [text_5, key_resp_6]
...
_key_resp_8_allKeys = []
# keep track of which components have finished
pro3Components = [image_3, key_resp_8]
for thisComponent in pro3Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
thisExp.nextEntry()
# the Routine "pro3" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()

# --- Prepare to start Routine "pro4" ---
continueRoutine = True
routineForceEnded = False
# update component parameters for each repeat
key_resp_9.keys = []
...
_key_resp_9_allKeys = []
# keep track of which components have finished
pro4Components = [image_4, key_resp_9]
for thisComponent in pro4Components:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
thisExp.nextEntry()
# the Routine "pro4" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
# keep track of which components have finished
endComponents = [text_6, key_resp_10]
